...
var app = angular.module("step6App", []);
...
app.controller("QuestionnaireCtrl", function ($scope) {
    $scope.questionnaire = [
        ...
        { number: "3", question: "Describe yourself", type: "text" },
        { number: "4", question: "Which is your favourite colour?", type: "singleOption" },
        { number: "4", question: "Which of the following sweets do you like?", type: "multiOption" },
    ];
